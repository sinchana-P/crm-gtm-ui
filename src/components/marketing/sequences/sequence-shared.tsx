...
> = {
  ...
  list_membership: { label: "Added to a list", icon: ListChecks, description: "Enroll when a contact is added to a static or dynamic list (bulk)." },
  ...
  deal_stage: { label: "Deal stage changes", icon: Briefcase, description: "Enroll when a deal moves to a stage (sales pipeline)." },
...
export const ACTION_META: Record<SequenceActionType, { label: string; icon: IconType }> = {
  ...
  assign_owner: { label: "Assign / rotate owner", icon: UserCheck },
