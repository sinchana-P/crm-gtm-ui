...
export interface UnsubRatePoint {
  date: string;
  label: string;
  rate: number; // unsubscribe rate %
  sends: number;
  unsubs: number;
}

export interface UnsubByCampaign {
  id: string;
  campaign: string;
  sentAt: string;
  delivered: number;
...
export interface UnsubByTopic {
  topic: string;
  optOuts: number;
  rate: number;
}

export interface UnsubReasonStat {
  reason: string;
  count: number;
  pct: number;
}

export const UNSUB_KPIS = {
  rate30d: 0.24, // %
  ratePrev: 0.31,
  benchmark: 0.26, // industry avg %
  totalUnsubs30d: 368,
  optDowns: 214, // chose "manage preferences" instead of full opt-out
  listGrowthNet: 3.9, // net list growth %
};

export const UNSUB_RATE_TREND: UnsubRatePoint[] = [
  { date: "2026-05-01", label: "Wk 1", rate: 0.34, sends: 41200, unsubs: 140 },
  { date: "2026-05-08", label: "Wk 2", rate: 0.31, sends: 38900, unsubs: 121 },
  { date: "2026-05-15", label: "Wk 3", rate: 0.29, sends: 44100, unsubs: 128 },
  { date: "2026-05-22", label: "Wk 4", rate: 0.27, sends: 39800, unsubs: 107 },
  { date: "2026-05-29", label: "Wk 5", rate: 0.26, sends: 42600, unsubs: 111 },
  { date: "2026-06-05", label: "Wk 6", rate: 0.25, sends: 45300, unsubs: 113 },
  { date: "2026-06-12", label: "Wk 7", rate: 0.22, sends: 47100, unsubs: 104 },
  { date: "2026-06-19", label: "Wk 8", rate: 0.24, sends: 43800, unsubs: 105 },
];

export const UNSUB_BY_CAMPAIGN: UnsubByCampaign[] = [
  { id: "c1", campaign: "June Newsletter", sentAt: "2026-06-24T09:00:00Z", delivered: 11840, unsubs: 18, rate: 0.15, status: "healthy" },
  { id: "c2", campaign: "Top 40 Nominations — Reminder", sentAt: "2026-06-22T10:00:00Z", delivered: 9210, unsubs: 41, rate: 0.45, status: "high" },
  { id: "c3", campaign: "Membership Q2 Push", sentAt: "2026-06-20T08:30:00Z", delivered: 8640, unsubs: 24, rate: 0.28, status: "watch" },
  { id: "c4", campaign: "GA Tech Summit Invite", sentAt: "2026-06-18T14:00:00Z", delivered: 6120, unsubs: 9, rate: 0.15, status: "healthy" },
  { id: "c5", campaign: "Product Update — May", sentAt: "2026-06-14T11:00:00Z", delivered: 12040, unsubs: 22, rate: 0.18, status: "healthy" },
  { id: "c6", campaign: "Weekend Offer", sentAt: "2026-06-10T07:00:00Z", delivered: 7350, unsubs: 33, rate: 0.45, status: "high" },
];

export const UNSUB_BY_TOPIC: UnsubByTopic[] = [
  { topic: "Offers & promotions", optOuts: 142, rate: 0.42 },
  { topic: "Product updates", optOuts: 88, rate: 0.21 },
  { topic: "Newsletter", optOuts: 71, rate: 0.19 },
  { topic: "Events & webinars", optOuts: 47, rate: 0.16 },
  { topic: "Transactional", optOuts: 0, rate: 0 },
];

export const UNSUB_REASONS: UnsubReasonStat[] = [
