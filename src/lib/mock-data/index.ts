...
export const MOCK_CAMPAIGNS: Campaign[] = [
  {
    id: "cp-ab-run",
    name: "Webinar Invite — subject line test",
    description: "Testing a curiosity-led subject line against the straightforward one.",
    type: "one-time",
    status: "running",
    channel: "email",
    segmentId: "sg1",
    ...
    owner: "Priya Sharma",
    goals: [{ metric: "opens", target: 3000, current: 640 }],
    conversionTargets: [],
    utmEnabled: false,
    abTest: {
      enabled: true,
      status: "running",
      testedVariable: "subject_line",
      splitMode: "sample_and_rollout",
      samplePercent: 20,
      ...
      testWindowHours: 4,
      fallbackVariantId: "r1",
      dispatchedAt: 1755511200000, // 18 Aug 2026 10:00 UTC
      evaluateAt: 1755525600000, // +4h
      rolloutSize: 9984,
      extensionCount: 0,
      variants: [
        {
          id: "r1", label: "Version A", name: "Straightforward", subject: "Join our Q3 product webinar", preheader: "Q3 highlights and what's next.", senderName: "Connect NX",
          blocks: [
            { id: "r1b1", type: "heading", level: 1, text: "Your Q3 report", align: "left" },
            { id: "r1b2", type: "text", text: "Hi {{firstName}}, here's how your team performed last quarter.", align: "left" },
            { id: "r1b3", type: "button", text: "Open the report", url: "https://connectnx.io/report", align: "left", buttonColor: "#2563eb" },
            { id: "r1b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: true, weight: 50,
          assigned: 1248, sent: 1248, delivered: 1229, opened: 327, clicked: 97, converted: 23, bounced: 19, unsubscribed: 2,
        },
        {
          id: "r2", label: "Version B", name: "Curiosity-led", subject: "The 3 things changing in Q3 — live walkthrough", preheader: "Q3 highlights and what's next.", senderName: "Connect NX",
          blocks: [
            { id: "r2b1", type: "heading", level: 1, text: "Your Q3 report", align: "left" },
            { id: "r2b2", type: "text", text: "Hi {{firstName}}, here's how your team performed last quarter.", align: "left" },
            { id: "r2b3", type: "button", text: "Open the report", url: "https://connectnx.io/report", align: "left", buttonColor: "#2563eb" },
            { id: "r2b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: false, weight: 50,
          assigned: 1248, sent: 1248, delivered: 1231, opened: 387, clicked: 101, converted: 26, bounced: 17, unsubscribed: 4,
        },
      ],
    },
    ...
    sent: 12480, delivered: 2460, opened: 714, clicked: 198, bounced: 36, unsubscribed: 6, converted: 49,
  },
  {
    id: "ab-decide",
    name: "Renewal Nudge — content test",
    description: "Long-form value recap against a short single-CTA layout. Manual winner selection.",
    type: "one-time",
    status: "running",
    channel: "email",
    segmentId: "sg2",
    ...
    templateName: "Product Launch Hero",
    owner: "Arun Menon",
    goals: [{ metric: "clicks", target: 900, current: 214 }],
    conversionTargets: [],
    utmEnabled: false,
    abTest: {
      enabled: true,
      status: "awaiting_decision",
      testedVariable: "content",
      splitMode: "sample_and_rollout",
      samplePercent: 30,
      ...
      minSamplePerVariant: 1000,
      testWindowHours: 8,
      fallbackVariantId: "d1",
      dispatchedAt: 1755468000000, // 17 Aug 2026 22:00 UTC
      evaluateAt: 1755496800000,
      evaluatedAt: 1755496800000,
      winnerConfidence: 0.881,
      inconclusiveReason: "no_significance",
      rolloutSize: 5810,
      comparisons: [
        { leaderId: "d2", againstId: "d1", rawPValue: 0.119, adjustedPValue: 0.119, significant: false },
      ],
      variants: [
        {
          id: "d1", label: "Version A", name: "Long-form recap", subject: "Your plan renews soon",
          preheader: "Everything you've shipped with Connect this year.",
          senderName: "Connect NX", templateId: "t1", templateName: "Product Launch Hero",
          blocks: [
            { id: "d1b1", type: "heading", level: 1, text: "A year of progress, {{firstName}}", align: "left" },
            { id: "d1b2", type: "text", text: "Your team closed 38% more deals since switching to Connect. Here's the detail behind that number, and what's landing next quarter.", align: "left" },
            { id: "d1b3", type: "columns", colText: ["1,240 deals closed", "38% faster cycle"] },
            { id: "d1b4", type: "text", text: "Your plan renews on the 30th. Nothing to do — we'll email a receipt.", align: "left" },
            { id: "d1b5", type: "button", text: "Review your plan", url: "https://connectnx.io/billing", align: "left", buttonColor: "#2563eb" },
            { id: "d1b6", type: "divider" },
            { id: "d1b7", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: true, weight: 50,
          assigned: 1245, sent: 1245, delivered: 1233, opened: 402, clicked: 101, converted: 26, bounced: 12, unsubscribed: 3,
        },
        {
          id: "d2", label: "Version B", name: "Short single-CTA", subject: "Your plan renews soon",
          preheader: "One thing to check before the 30th.",
          senderName: "Priya at Connect NX", templateId: "t1", templateName: "Product Launch Hero",
          blocks: [
            { id: "d2b1", type: "heading", level: 2, text: "Renewing on the 30th", align: "center" },
            { id: "d2b2", type: "text", text: "{{firstName}}, your plan renews automatically. Take a look if anything's changed.", align: "center" },
            { id: "d2b3", type: "button", text: "Review your plan", url: "https://connectnx.io/billing", align: "center", buttonColor: "#059669" },
            { id: "d2b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: false, weight: 50,
          assigned: 1245, sent: 1245, delivered: 1236, opened: 409, clicked: 121, converted: 31, bounced: 9, unsubscribed: 4,
        },
      ],
    },
    scheduledAt: "2026-08-17T22:00:00Z",
    lastRunAt: "2026-08-17T22:00:00Z",
    createdAt: "2026-08-12T10:00:00Z",
    updatedAt: "2026-08-18T06:00:00Z",
    sent: 8300, delivered: 2469, opened: 811, clicked: 222, bounced: 21, unsubscribed: 7, converted: 57,
  },
  {
    id: "cp1",
    ...
    abTest: {
      ...
      minSamplePerVariant: 1000,
      testWindowHours: 4,
      fallbackVariantId: "v1",
      dispatchedAt: 1749546000000,
      evaluateAt: 1749560400000,
      evaluatedAt: 1749560400000,
      winningVariantId: "v2",
      winnerIsSignificant: true,
      winnerConfidence: 0.973,
      winnerSelectedBy: "SYSTEM",
      rolloutSize: 3360,
      rolloutSentAt: 1749561000000,
      comparisons: [
        { leaderId: "v2", againstId: "v1", rawPValue: 0.0091, adjustedPValue: 0.0091, significant: true },
      ],
      variants: [
        {
          id: "v1", label: "Version A", name: "Plain subject", subject: "Q3 report", preheader: "Q3 highlights and what's next.", senderName: "Connect NX",
          blocks: [
            { id: "v1b1", type: "heading", level: 1, text: "Your Q3 report", align: "left" },
            { id: "v1b2", type: "text", text: "Hi {{firstName}}, here's how your team performed last quarter.", align: "left" },
            { id: "v1b3", type: "button", text: "Open the report", url: "https://connectnx.io/report", align: "left", buttonColor: "#2563eb" },
            { id: "v1b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: true, weight: 50,
          assigned: 420, sent: 420, delivered: 414, opened: 110, clicked: 33, converted: 8, bounced: 6, unsubscribed: 1,
        },
        {
          id: "v2", label: "Version B", name: "Emoji + personal", subject: "Your Q3 report is ready 📊", preheader: "Q3 highlights and what's next.", senderName: "Connect NX",
          blocks: [
            { id: "v2b1", type: "heading", level: 1, text: "Your Q3 report", align: "left" },
            { id: "v2b2", type: "text", text: "Hi {{firstName}}, here's how your team performed last quarter.", align: "left" },
            { id: "v2b3", type: "button", text: "Open the report", url: "https://connectnx.io/report", align: "left", buttonColor: "#2563eb" },
            { id: "v2b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: false, weight: 50,
          assigned: 420, sent: 420, delivered: 417, opened: 131, clicked: 40, converted: 11, bounced: 3, unsubscribed: 1,
          winner: true,
        },
      ],
    },
  ...
  },
  {
    ...
    abTest: {
      ...
      minSamplePerVariant: 1000,
      testWindowHours: 72,
      dispatchedAt: 1755079200000,
      evaluateAt: 1755338400000,
      evaluatedAt: 1755338400000,
      winnerConfidence: 0.962,
      rolloutSize: 0,
      comparisons: [
        { leaderId: "w2", againstId: "w1", rawPValue: 0.0038, adjustedPValue: 0.0038, significant: true },
      ],
      variants: [
        {
          id: "w1", label: "Version A", name: "This week at Connect", subject: "This week at Connect",
          preheader: "Q3 highlights and what's next.", senderName: "Connect NX",
          blocks: [
            { id: "w1b1", type: "heading", level: 1, text: "Your Q3 report", align: "left" },
            { id: "w1b2", type: "text", text: "Hi {{firstName}}, here's how your team performed last quarter.", align: "left" },
            { id: "w1b3", type: "button", text: "Open the report", url: "https://connectnx.io/report", align: "left", buttonColor: "#2563eb" },
            { id: "w1b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: true, weight: 50,
          assigned: 1806, sent: 1806, delivered: 1789, opened: 604, clicked: 141, converted: 34, bounced: 17, unsubscribed: 4,
        },
        {
          id: "w2", label: "Version B", name: "3 things worth 2 minutes", subject: "3 things worth 2 minutes",
          preheader: "Q3 highlights and what's next.", senderName: "Connect NX",
          blocks: [
            { id: "w2b1", type: "heading", level: 1, text: "Your Q3 report", align: "left" },
            { id: "w2b2", type: "text", text: "Hi {{firstName}}, here's how your team performed last quarter.", align: "left" },
            { id: "w2b3", type: "button", text: "Open the report", url: "https://connectnx.io/report", align: "left", buttonColor: "#2563eb" },
            { id: "w2b4", type: "text", text: "{{unsubscribeLink}}", align: "center" },
          ],
          isControl: false, weight: 50,
          assigned: 1804, sent: 1804, delivered: 1791, opened: 651, clicked: 187, converted: 46, bounced: 13, unsubscribed: 5,
          winner: true,
        },
      ],
    },
