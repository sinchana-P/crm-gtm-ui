...
export const MOCK_SEQUENCES: Sequence[] = [
  ...
  },
  {
    ...
    triggers: [{ id: "t5", type: "tag_added", tag: "event-attendee" }],
    exit: { ...DEFAULT_EXIT, pauseOnReply: false },
    flow: [
      { id: "s3st1", type: "email", label: "Thank you", templateId: "t4", subject: "Thanks for joining Connect Summit" },
      { id: "s3st2", type: "wait", label: "Wait 1 day", waitMode: "duration", waitValue: 1, waitUnit: "days" },
      { id: "s3st3", type: "email", label: "Resource pack", templateId: "t1", subject: "Your Connect Summit resource pack" },
      { id: "s3st4", type: "action", label: "Task: book meeting", actionType: "create_task", actionSummary: "Assign meeting booking to owner" },
    ],
  },
  {
    id: "s4",
  ...
  },
  {
    ...
    updatedAt: "2025-11-20T09:00:00Z",
    triggers: [{ id: "t7", type: "manual" }],
    exit: { ...DEFAULT_EXIT, pauseOnReply: false },
    flow: [
      { id: "s5st1", type: "email", label: "Festive greetings", templateId: "t1", subject: "Happy Diwali from Connect" },
      { id: "s5st2", type: "wait", label: "Wait 2 days", waitMode: "duration", waitValue: 2, waitUnit: "days" },
      { id: "s5st3", type: "email", label: "Festive offer", templateId: "t3", subject: "Our Diwali gift to you" },
    ],
  },
];
...
export const MOCK_SEQUENCE_TEMPLATES: SequenceTemplate[] = [
  ...
  },
  {
    ...
    category: "event",
    channel: "multi",
    triggers: [{ id: "tt3", type: "tag_added", tag: "event-registered" }],
    exit: { ...DEFAULT_EXIT, pauseOnReply: false },
    flow: [
      { id: "ev1", type: "email", label: "You're registered", templateId: "t4", subject: "You're in — here are the details" },
      { id: "ev2", type: "wait", label: "Wait until 1 day before", waitMode: "until_date", waitField: "eventDate", waitValue: -1, waitUnit: "days" },
      { id: "ev3", type: "whatsapp", label: "WhatsApp reminder", snippet: "See you tomorrow at Connect Summit!" },
      { id: "ev4", type: "wait", label: "Wait until day after", waitMode: "until_date", waitField: "eventDate", waitValue: 1, waitUnit: "days" },
      { id: "ev5", type: "email", label: "Thanks + resources", templateId: "t4", subject: "Thanks for joining — your resource pack" },
    ],
  },
  {
    id: "tpl-sales",
  ...
  },
  {
    ...
    category: "feedback",
    channel: "email",
    triggers: [{ id: "tt5", type: "custom_event", eventName: "order_completed" }],
    exit: { ...DEFAULT_EXIT },
    flow: [
      { id: "fb1", type: "wait", label: "Wait 3 days", waitMode: "duration", waitValue: 3, waitUnit: "days" },
      { id: "fb2", type: "email", label: "How did we do?", templateId: "t4", subject: "Quick favor, {{firstName}}?" },
      { id: "fb3", type: "wait", label: "Wait until responded (max 5 days)", waitMode: "until_condition", waitCondition: "survey_responded = true", waitTimeoutDays: 5 },
      { id: "fb4", type: "action", label: "Notify owner of response", actionType: "notify_owner", actionSummary: "Email owner with survey result" },
    ],
  },
];
