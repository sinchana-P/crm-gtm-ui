...
export const MOCK_SEQUENCE_TEMPLATES: SequenceTemplate[] = [
  ...
  },
  {
    ...
    description: "Guide trial users to their first win, then nudge an upgrade before the trial ends.",
    type: "marketing",
    category: "onboarding",
    channel: "email",
    triggers: [{ id: "tt6", type: "custom_event", eventName: "trial_started" }],
    exit: { ...DEFAULT_EXIT, goalEnabled: true, goalCondition: "plan = paid" },
    flow: [
      { id: "tr1", type: "email", label: "Get started in 3 steps", templateId: "t2", subject: "Welcome to your trial, {{firstName}}" },
      { id: "tr2", type: "wait", label: "Wait 2 days", waitMode: "duration", waitValue: 2, waitUnit: "days" },
      { id: "tr3", type: "branch", label: "Activated the product?", branchKind: "if_else", branches: [
        { id: "trb1", label: "Yes", condition: "activated = true", steps: [
          { id: "tr4", type: "email", label: "Pro tip to go further", templateId: "t1", subject: "You're set up — here's a power move" },
        ] },
        { id: "trb2", label: "No", steps: [
          { id: "tr5", type: "email", label: "Need a hand getting started?", templateId: "t1", subject: "Stuck? We can help in 10 minutes" },
          { id: "tr6", type: "action", label: "Task: CS check-in", actionType: "create_task", actionSummary: "CS to reach out" },
        ] },
      ] },
      { id: "tr7", type: "wait", label: "Wait until 3 days before end", waitMode: "until_date", waitField: "trialEndDate", waitValue: -3, waitUnit: "days" },
      { id: "tr8", type: "email", label: "Upgrade nudge", templateId: "t3", subject: "Your trial ends soon — keep going" },
      { id: "tr9", type: "goal", label: "Goal: upgraded to paid", goalCondition: "plan = paid" },
    ],
  },
  {
    id: "tpl-lead-magnet",
    ...
    description: "Deliver the downloaded asset, then nurture toward a demo over a few touches.",
    type: "marketing",
    category: "welcome",
    channel: "email",
    triggers: [{ id: "tt7", type: "form_submitted", formId: "f1" }],
    exit: { ...DEFAULT_EXIT },
    flow: [
      { id: "lm1", type: "email", label: "Here's your download", templateId: "t2", subject: "Your guide is inside, {{firstName}}" },
      { id: "lm2", type: "wait", label: "Wait 2 days", waitMode: "duration", waitValue: 2, waitUnit: "days" },
      { id: "lm3", type: "email", label: "Related resources", templateId: "t1", subject: "3 more reads you'll like" },
      { id: "lm4", type: "wait", label: "Wait 3 days", waitMode: "duration", waitValue: 3, waitUnit: "days" },
      { id: "lm5", type: "email", label: "Invite to a demo", templateId: "t1", subject: "Want to see it live?" },
    ],
  },
  {
    id: "tpl-demo-noshow",
    ...
    description: "Re-book prospects who missed their scheduled demo, with a rep task fallback.",
    type: "sales",
    category: "sales",
    channel: "multi",
    triggers: [{ id: "tt8", type: "custom_event", eventName: "demo_no_show" }],
    exit: { ...DEFAULT_EXIT, pauseOnReply: true },
    flow: [
      { id: "dn1", type: "email", label: "Sorry we missed you", templateId: "t2", subject: "Missed you — let's find another time" },
      { id: "dn2", type: "wait", label: "Wait 1 day", waitMode: "duration", waitValue: 1, waitUnit: "days" },
      { id: "dn3", type: "whatsapp", label: "WhatsApp re-book nudge", snippet: "Hi {{firstName}}, happy to reschedule the demo — what suits you?" },
      { id: "dn4", type: "wait", label: "Wait 2 days", waitMode: "duration", waitValue: 2, waitUnit: "days" },
      { id: "dn5", type: "action", label: "Task: personal outreach", actionType: "create_task", actionSummary: "Rep to call and re-book" },
      { id: "dn6", type: "goal", label: "Goal: demo re-booked", goalCondition: "meeting_booked = true" },
    ],
  },
  {
    id: "tpl-renewal",
    ...
    description: "Warm up customers ahead of renewal and hand off to the owner near the date.",
    type: "sales",
    category: "re-engage",
    channel: "email",
    triggers: [{ id: "tt9", type: "date_based", dateField: "renewalDate", dateOffsetDays: -45 }],
    exit: { ...DEFAULT_EXIT, reEnrollment: "cooldown", reEnrollCooldownDays: 300 },
    flow: [
      { id: "rn1", type: "email", label: "Value recap (T-45)", templateId: "t4", subject: "What you've achieved this year" },
      { id: "rn2", type: "wait", label: "Wait until 14 days before", waitMode: "until_date", waitField: "renewalDate", waitValue: -14, waitUnit: "days" },
      { id: "rn3", type: "email", label: "Renewal reminder (T-14)", templateId: "t2", subject: "Your renewal is coming up" },
      { id: "rn4", type: "action", label: "Task: owner renewal call", actionType: "create_task", actionSummary: "Owner to confirm renewal" },
    ],
  },
  {
    id: "tpl-onboarding",
    ...
    description: "Drive new customers to first value with setup steps, a first-win nudge, and a CSM check-in.",
    type: "marketing",
    category: "onboarding",
    channel: "email",
    triggers: [{ id: "tt10", type: "custom_event", eventName: "account_activated" }],
    exit: { ...DEFAULT_EXIT, goalEnabled: true, goalCondition: "activated_key_feature = true" },
    flow: [
      { id: "ob1", type: "email", label: "Welcome + setup checklist", templateId: "t2", subject: "Welcome aboard — let's get you set up" },
      { id: "ob2", type: "wait", label: "Wait 2 days", waitMode: "duration", waitValue: 2, waitUnit: "days" },
      { id: "ob3", type: "email", label: "Reach your first win", templateId: "t1", subject: "The one thing to do first" },
      { id: "ob4", type: "wait", label: "Wait 3 days", waitMode: "duration", waitValue: 3, waitUnit: "days" },
      { id: "ob5", type: "branch", label: "Activated key feature?", branchKind: "if_else", branches: [
        { id: "obb1", label: "Yes", condition: "activated_key_feature = true", steps: [
          { id: "ob6", type: "email", label: "Advanced tips", templateId: "t1", subject: "Level up in 5 minutes" },
        ] },
        { id: "obb2", label: "No", steps: [
          { id: "ob7", type: "action", label: "Task: CSM check-in", actionType: "create_task", actionSummary: "CSM to reach out" },
        ] },
      ] },
      { id: "ob8", type: "goal", label: "Goal: activated", goalCondition: "activated_key_feature = true" },
    ],
  },
  {
    id: "tpl-upsell",
    ...
    description: "After a purchase, recommend complementary products and reward the next order with a nudge.",
    type: "marketing",
    category: "re-engage",
    channel: "email",
    triggers: [{ id: "tt11", type: "custom_event", eventName: "order_completed" }],
    exit: { ...DEFAULT_EXIT },
    flow: [
      { id: "up1", type: "wait", label: "Wait 5 days", waitMode: "duration", waitValue: 5, waitUnit: "days" },
      { id: "up2", type: "email", label: "You might also like…", templateId: "t3", subject: "Pairs well with your order" },
      { id: "up3", type: "wait", label: "Wait 4 days", waitMode: "duration", waitValue: 4, waitUnit: "days" },
      { id: "up4", type: "branch", label: "Clicked a recommendation?", branchKind: "if_else", branches: [
        { id: "upb1", label: "Yes", condition: "clicked_any_sequence_email = true", steps: [
          { id: "up5", type: "email", label: "A little nudge — 10% off", templateId: "t3", subject: "Complete the set for 10% off" },
        ] },
        { id: "upb2", label: "No", steps: [] },
      ] },
    ],
  },
  {
    ...
    description: "Confirm a booked meeting, share the agenda, and remind before it starts to cut no-shows.",
    type: "sales",
    category: "sales",
    channel: "multi",
    triggers: [{ id: "tt12", type: "custom_event", eventName: "meeting_booked" }],
    exit: { ...DEFAULT_EXIT, pauseOnReply: true },
    flow: [
      { id: "mt1", type: "email", label: "Confirmed — here's the agenda", templateId: "t2", subject: "You're booked — what we'll cover" },
      { id: "mt2", type: "wait", label: "Wait until 1 day before", waitMode: "until_date", waitField: "meetingDate", waitValue: -1, waitUnit: "days" },
      { id: "mt3", type: "whatsapp", label: "WhatsApp reminder", snippet: "Hi {{firstName}}, looking forward to our call tomorrow!" },
      { id: "mt4", type: "wait", label: "Wait until 1 hour before", waitMode: "until_date", waitField: "meetingDate", waitValue: -1, waitUnit: "hours" },
      { id: "mt5", type: "email", label: "Starting soon", templateId: "t2", subject: "See you in an hour" },
    ],
  },
];
...
export const MOCK_AUTOMATION_RECIPES: AutomationRecipe[] = [
  ...
  },
  {
    ...
    description: "Round-robin new leads to reps by territory and create a first-touch task.",
    category: "sales",
    triggers: [{ id: "rt7", type: "list_membership", listName: "New Leads" }],
    settings: { reEnrollment: "never", quietHours: false },
    nodes: [
      { id: "r1", type: "action", label: "Rotate to territory owner", actionType: "rotate_owner", actionSummary: "Round-robin by territory" },
      { id: "r2", type: "action", label: "Create first-touch task", actionType: "create_task", actionSummary: "Call within 1 business day" },
      { id: "r3", type: "action", label: "Notify assigned rep", actionType: "notify_team", actionSummary: "New lead assigned" },
    ],
  },
  {
    id: "rec-score",
    name: "Engagement lead scoring",
    description: "Add points when a contact clicks, then promote and alert sales when they turn hot.",
    category: "lead",
    triggers: [{ id: "rt8", type: "email_engagement", engagementEvent: "clicked" }],
    settings: { reEnrollment: "always", quietHours: false },
    nodes: [
      { id: "r1", type: "action", label: "Add +10 to lead score", actionType: "adjust_score", actionSummary: "+10 points" },
      { id: "r2", type: "branch", label: "Score above 80?", branchKind: "if_else", branches: [
        { id: "r2-y", label: "Yes", condition: "leadScore > 80", nodes: [
          { id: "r3", type: "action", label: "Set lifecycle = SQL", actionType: "set_lifecycle", actionSummary: "sql" },
          { id: "r4", type: "action", label: "Notify sales", actionType: "notify_team", actionSummary: "Hot lead alert" },
        ] },
        { id: "r2-n", label: "No", nodes: [] },
      ] },
    ],
  },
  {
    ...
    description: "30 days before renewal, remind the customer and create a task for their owner.",
    category: "retention",
    triggers: [{ id: "rt9", type: "date_based", dateField: "renewalDate", dateOffsetDays: -30 }],
    settings: { reEnrollment: "cooldown", reEnrollCooldownDays: 300, quietHours: true },
    nodes: [
      { id: "r1", type: "send_email", label: "Your plan renews soon", templateId: "t2", subject: "A quick heads-up on your renewal" },
      { id: "r2", type: "action", label: "Create renewal task", actionType: "create_task", actionSummary: "Owner: confirm renewal" },
      { id: "r3", type: "delay", label: "Delay 23 days", delayMode: "duration", delayValue: 23, delayUnit: "days" },
      { id: "r4", type: "send_email", label: "Final reminder (T-7)", templateId: "t2", subject: "Renewing next week" },
    ],
  },
  {
    id: "rec-cleanup",
    name: "Unsubscribe housekeeping",
    description: "When someone unsubscribes, clear consent and remove them from active sends.",
    category: "ops",
    triggers: [{ id: "rt10", type: "tag_added", tag: "unsubscribed" }],
    settings: { reEnrollment: "always", quietHours: false },
    nodes: [
      { id: "r1", type: "action", label: "Turn off email consent", actionType: "set_property", actionSummary: "consent.email = false" },
      { id: "r2", type: "action", label: "Remove from nurture", actionType: "unenroll_sequence", actionSummary: "All marketing sequences" },
      { id: "r3", type: "action", label: "Tag as suppressed", actionType: "add_tag", actionSummary: "suppressed" },
    ],
  },
  {
    id: "rec-pageview",
    name: "High-intent page visit",
    description: "When a known contact views pricing, score them, send a tailored email, and alert their owner.",
    category: "lead",
    triggers: [{ id: "rt11", type: "page_viewed", pageUrl: "/pricing" }],
    settings: { reEnrollment: "cooldown", reEnrollCooldownDays: 14, quietHours: true },
    nodes: [
      { id: "r1", type: "action", label: "Add +15 to lead score", actionType: "adjust_score", actionSummary: "+15 points" },
      { id: "r2", type: "send_email", label: "Questions about pricing?", templateId: "t1", subject: "Happy to help with pricing" },
      { id: "r3", type: "action", label: "Notify owner", actionType: "notify_team", actionSummary: "High-intent page visit" },
    ],
  },
  {
    id: "rec-deal-task",
    name: "New deal → owner task",
    description: "When a deal enters the pipeline, create a follow-up task and alert the deal owner.",
    category: "sales",
    triggers: [{ id: "rt12", type: "deal_stage", dealStage: "New" }],
    settings: { reEnrollment: "always", quietHours: false },
    nodes: [
      { id: "r1", type: "action", label: "Create follow-up task", actionType: "create_task", actionSummary: "Owner: qualify within 24h" },
      { id: "r2", type: "action", label: "Notify deal owner", actionType: "notify_team", actionSummary: "New deal assigned" },
      { id: "r3", type: "action", label: "Tag as open-deal", actionType: "add_tag", actionSummary: "open-deal" },
    ],
  },
  {
    id: "rec-mql",
    name: "MQL → sales handoff",
    description: "When a contact becomes an MQL, assign a rep, open a deal, and start the sales cadence.",
    category: "sales",
    triggers: [{ id: "rt13", type: "property_changed", property: "lifecycleStage", operator: "equals", value: "mql" }],
    settings: { reEnrollment: "never", quietHours: true },
    nodes: [
      { id: "r1", type: "action", label: "Rotate to sales owner", actionType: "rotate_owner", actionSummary: "Sales round-robin" },
      { id: "r2", type: "action", label: "Create deal", actionType: "create_deal", actionSummary: "New business — discovery stage" },
      { id: "r3", type: "action", label: "Enroll in sales cadence", actionType: "enroll_sequence", actionSummary: "Outbound Sales Cadence" },
    ],
  },
  {
    id: "rec-hygiene",
    name: "Data hygiene cleanup",
    description: "Standardize new records, flag missing email or phone, and queue an ops task to complete them.",
    category: "ops",
    triggers: [{ id: "rt14", type: "property_changed", property: "company", operator: "is_known" }],
    settings: { reEnrollment: "always", quietHours: false },
    nodes: [
      { id: "r1", type: "action", label: "Normalize country + title case", actionType: "set_property", actionSummary: "Standardize formatting" },
      { id: "r2", type: "branch", label: "Missing email or phone?", branchKind: "if_else", branches: [
        { id: "r2-y", label: "Yes", condition: "email is empty OR phone is empty", nodes: [
          { id: "r3", type: "action", label: "Tag needs-review", actionType: "add_tag", actionSummary: "needs-review" },
          { id: "r4", type: "action", label: "Create data task", actionType: "create_task", actionSummary: "Ops: complete record" },
        ] },
        { id: "r2-n", label: "No", nodes: [] },
      ] },
    ],
